...
##cp /sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/MuSysMinitrees_v6/miniTree*MuSys_itoy${9}*partALL.root ${TMPDIR}/
##cp /sps/cms/sgandurr/CMSSW_5_3_7_RECO_5_3_3_v4/src/Selection_July2013/MuSysMinitrees_v6_RecoEnergy/miniTree*MuSys_itoy${9}*RecoEnergy*partALL.root ${TMPDIR}/
cp ${SPSDIR}/ZmmgStudies/Selection/MuSysMinitrees_thesis_v1/miniTree_*MuSys_itoy${9}_thesis_v1*.root ${TMPDIR}/
...
do
	...
	do
		for fitFunction in 'voigtian' ##'cruijff' //FIXME
		do
			echo "${eta}, ${r9} r9, ${fitFunction} :" 
			./SFits.exe ${1} ${2} ${3} ${4} ${5} ${6} ${eta} ${r9} ${fitFunction} ${7} ${8} ${9} 0 ${10} >> sortie_${1}_${2}_${3}_${4}_${5}_${6}_${eta}_${r9}_${fitFunction}_${7}_${8}_${9}_${10}.out 2> sortie_${1}_${2}_${3}_${4}_${5}_${6}_${eta}_${r9}_${fitFunction}_${7}_${8}_${9}_${10}.err
		done
	done
done
...
mv ${TMPDIR}/sortie_${1}_${2}_${3}_${4}_${5}_${6}_*_*_*_${7}_${8}_${9}_${10}.err ${SPSDIR}/ZmmgStudies/EnergyScaleAndResolution/logFiles/
mv ${TMPDIR}/sortie_${1}_${2}_${3}_${4}_${5}_${6}_*_*_*_${7}_${8}_${9}_${10}.out ${SPSDIR}/ZmmgStudies/EnergyScaleAndResolution/logFiles/
