...
int main(int argc, char *argv[])
{
	...
	//if(normalization == "lumi") cut += ")*weight_pileUp*weight_Xsection*weight_hlt_scaleFactors*weight_tightMuId_scaleFactors"; 
	//if(normalization == "integral") cut += ")*weight_pileUp*weight_hlt_scaleFactors*weight_tightMuId_scaleFactors"; 
...
*/
	...
	//dYToMuMuFSRChain->Add("/sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/miniTree_DYToMuMu_Summer12_NewMuonID_NewSelection_1_injRe0_PU_true_May2013_partALL.root");
        //dYToMuMuNonFSRChain->Add("/sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/miniTree_DYToMuMu_Summer12_NewMuonID_NewSelection_2_injRe0_PU_true_May2013_partALL.root");
        //ttJetsChain->Add("/sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/miniTree_TTJets_Summer12_S7_NewMuonID_NewSelection_3_injRe0_PU_true_May2013_partALL.root");
        //wJetsChain->Add("/sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/miniTree_WJetsToLNu_Summer12_S10_NewMuonID_NewSelection_3_injRe0_PU_true_May2013_partALL.root");
	...
	*/
	...
	if(log == 0 && (xVariable == "MuonM_Eta" || xVariable == "MuonP_Eta" || xVariable == "Photon_SC_Eta")) dYToMuMuFSR->GetYaxis()->SetRangeUser(Ymin,Ymax + Ymax * 0.2); 
        if(log == 1) dYToMuMuFSR->SetMinimum(pow(10.0,-2));
	if(log == 1 && (xVariable == "MuonM_Eta" || xVariable == "MuonP_Eta" || xVariable == "Photon_SC_Eta" || xVariable == "Mmumugamma" || xVariable == "Mmumu")) dYToMuMuFSR->SetMaximum(30 * Ymax);
