...
cp /sps/cms/sgandurr/CMSSW_5_3_6_RECO_5_3_3_v4/src/cvs_developpment/Selection_NewMuID/ClosureTestZeeMiniTrees_v6b/miniTree*v6*partALL.root ${TMPDIR}/
...
do
	...
	do
		...
		do
			...
			./SFits.exe ${1} ${2} ${3} ${4} ${5} ${6} ${eta} ${r9} ${fitFunction} ${7} ${8} ${9} ${10} >> sortie_${1}_${2}_${3}_${4}_${5}_${6}_${eta}_${r9}_${fitFunction}_${7}_${8}_${9}_${10}.out 2> sortie_${1}_${2}_${3}_${4}_${5}_${6}_${eta}_${r9}_${fitFunction}_${7}_${8}_${9}_${10}.err
		done
	done
done
...
mv ${TMPDIR}/sortie_${1}_${2}_${3}_${4}_${5}_${6}_*_*_*_${7}_${8}_${9}_${10}.err ${SPSDIR}/Energy_scale_extraction/logFiles/
mv ${TMPDIR}/sortie_${1}_${2}_${3}_${4}_${5}_${6}_*_*_*_${7}_${8}_${9}_${10}.out ${SPSDIR}/Energy_scale_extraction/logFiles/
