...
int main(int argc, char *argv[])
{
	...
	string directoryName = "data_MC_Pt_Comparison_entries";
	string eta = "Barrel";
	string r9 = "all";
	int log = 1;		
	...
	string fileName = "data_MC_Pt_Comparison";
	...
	TH1D *data = new TH1D("data","data", 30, 0, 150);	
	TH1D *dYToMuMuFSR = new TH1D("dYToMuMuFSR","dYToMuMuFSR", 30, 0, 150);
	TH1D *dYToMuMuNonFSR = new TH1D("dYToMuMuNonFSR","dYToMuMuNonFSR", 30, 0, 150);
	TH1D *ttJets = new TH1D("ttJets","ttJets", 30, 0, 150);
	TH1D *wJets = new TH1D("wJets","wJets", 30, 0, 150);				
		
	dataChain->Draw("Photon_Et>>data",cut);
	dYToMuMuFSRChain->Draw("Photon_Et>>dYToMuMuFSR",cut);
	dYToMuMuNonFSRChain->Draw("Photon_Et>>dYToMuMuNonFSR",cut);
	ttJetsChain->Draw("Photon_Et>>ttJets",cut);
	wJetsChain->Draw("Photon_Et>>wJets",cut);	
	...
	*/
	...
	dYToMuMuFSR->GetXaxis()->SetTitle("E_{T}^{#gamma} [GeV]");
	...
	*/
	...
	TLegend leg(0.67,0.7,0.91,0.9,"","brNDC");
	leg.SetTextFont(42);
