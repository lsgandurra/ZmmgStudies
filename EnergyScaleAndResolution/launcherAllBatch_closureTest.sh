	...
	do
		...
		do
			...
			do
				...
				qsub batchJob_closureTest.sh input Results_v6_autoClosureTest ${dataType} ${fitVariable} Photon_Et LimitesAllPtOneBin.txt ${fitPercentage} ${injectedResolution} 0 1
			done 
		done
        done
done
