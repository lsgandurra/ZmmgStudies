...
int main(int argc, char *argv[])
{
	...
	if(cutVariable == "NoCut") cutVariable = "Photon_r9_2";
	//TString cut = Form("(%s > %s && Photon_SC_E_2 > 70 && Photon_SC_E_2 < 110 && gammaGenMatched == 1",cutVariable.c_str(), cutVariableValue.c_str());
	TString cut = Form("(%s > %s && nSuperCluster > 25",cutVariable.c_str(), cutVariableValue.c_str());
	...
	if(r9 == "low" && eta == "Barrel") cut += " && Photon_isEB_2 == 1 && Photon_r9_2 < 0.94)";
        if(r9 == "high" && eta == "Barrel") cut += " && Photon_isEB_2 == 1 && Photon_r9_2 > 0.94)";
        if(r9 == "low" && eta == "Endcaps") cut += " && Photon_isEE_2 == 1 && Photon_r9_2 < 0.95)";
        if(r9 == "high" && eta == "Endcaps") cut += " && Photon_isEE_2 == 1 && Photon_r9_2 > 0.95)";
        if(r9 == "all" && eta == "Barrel") cut += " && Photon_isEB_2 == 1)";
        if(r9 == "all" && eta == "Endcaps") cut += " && Photon_isEE_2 == 1)";
	if(r9 == "all" && eta == "all") cut += " && (Photon_isEE_2 == 1 || Photon_isEB_2 == 1))";

	if(r9 == "low" && eta == "Barrel") cut2 += " && Photon_isEB_2 == 1 && Photon_r9_2 < 0.94)";
        if(r9 == "high" && eta == "Barrel") cut2 += " && Photon_isEB_2 == 1 && Photon_r9_2 > 0.94)";
        if(r9 == "low" && eta == "Endcaps") cut2 += " && Photon_isEE_2 == 1 && Photon_r9_2 < 0.95)";
        if(r9 == "high" && eta == "Endcaps") cut2 += " && Photon_isEE_2 == 1 && Photon_r9_2 > 0.95)";
        if(r9 == "all" && eta == "Barrel") cut2 += " && Photon_isEB_2 == 1)";
        if(r9 == "all" && eta == "Endcaps") cut2 += " && Photon_isEE_2 == 1)";
        if(r9 == "all" && eta == "all") cut2 += " && (Photon_isEE_2 == 1 || Photon_isEB_2 == 1))";	
	...
	TFile * dYToMuMuRD1File = new TFile("/sps/cms/sgandurr/CMSSW_5_3_11_patch3_RECO_5_3_11_v1_hggpaperV5/src/ZmmgStudies/Selection/miniFriend2_totouples_DYToMuMu_Summer12_February2014_noskim_1_injRe0_v14_partALL.root");
        TFile * dYToMuMuPUS10File = new TFile("/sps/cms/sgandurr/CMSSW_5_3_11_patch3_RECO_5_3_11_v1_hggpaperV5/src/ZmmgStudies/Selection/miniFriend2_DYToMuMu_Summer12_PU_S10_noskim_1_injRe0_v14_partALL.root");
	
	TTree *dYToMuMuRD1Chain;
	TTree *dYToMuMuPUS10Chain;
	
	dYToMuMuRD1File->GetObject("miniFriend2",dYToMuMuRD1Chain);
	dYToMuMuPUS10File->GetObject("miniFriend2",dYToMuMuPUS10Chain);
