...
int main(int argc, char *argv[])
{
	...
	string directoryName = "Resolution_test";
	string dataType = "MC";
	...
	string eta = "Barrel"; 
	string r9 = "all";
	string fitFunction = "voigtianXgauss"; 
	string fitPercentageS = "95";
	double fitPercentage = 95;
	string injectedResolution = "0.01";
	...
	if(injectedResolution == "0.00") injectedResolutionTemp = 0;
	if(injectedResolution == "0.01") injectedResolutionTemp = 1;
	if(injectedResolution == "0.02") injectedResolutionTemp = 2;
	if(injectedResolution == "0.03") injectedResolutionTemp = 3;
	if(injectedResolution == "0.04") injectedResolutionTemp = 4;
	if(injectedResolution == "0.05") injectedResolutionTemp = 5;

	directoryName += Form("/InjectedResolution_%dPercent/%s/%sPercents/%s_%s_%sR9_%s/",injectedResolutionTemp,dataType.c_str(),fitPercentageS.c_str(),fitVariable.c_str(),eta.c_str(),r9.c_str(),fitFunction.c_str());
	...
	if(dataType == "data")
        {
                chain->Add(Form("miniTree_Run2012A_13Jul2012_v1_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_Run2012A_recover_06Aug2012_v1_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_Run2012B_13Jul2012_v4_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_Run2012C-24Aug2012-v1_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_Run2012C-EcalRecover_11Dec2012-v1_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));      
		chain->Add(Form("miniTree_Run2012C_PromptReco_v2_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_Run2012D_PromptReco_v1_NewMuonID_NewSelection_0_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                //chain->Add(Form("miniTree_2011A_03Oct2011V1ReReco_toto_v2_NewSelection_0_v6_partALL.root"));
                //chain->Add(Form("miniTree_2011A_05Jul2011ReReco_toto_v2_NewSelection_0_v6_partALL.root"));
                //chain->Add(Form("miniTree_2011A_PromptSkimV5ReReco_toto_v2_NewSelection_0_v6_partALL.root"));
                //chain->Add(Form("miniTree_2011B_PromptSkimV1ReReco_toto_v2_NewSelection_0_v6_partALL.root"));
        }
        if(dataType == "MC")
        {
                chain->Add(Form("miniTree_DYToMuMu_Summer12_NewMuonID_NewSelection_1_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                chain->Add(Form("miniTree_DYToMuMu_Summer12_NewMuonID_NewSelection_2_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                //chain->Add(Form("miniTree_TTJets_Summer12_S7_NewMuonID_NewSelection_3_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                //chain->Add(Form("miniTree_WJetsToLNu_Summer12_S10_NewMuonID_NewSelection_3_injRe%s_v1_partALL.root",injectedResolution.c_str()));
                //chain->Add(Form("miniTree_DYToMuMu_M-20_CT10_TuneZ2_7TeV-powheg-pythia_Fall11-PU_S6_START42_V14B-v1_September12_NewSelection_1_v6_partALL.root"));
                //chain->Add(Form("miniTree_DYToMuMu_M-20_CT10_TuneZ2_7TeV-powheg-pythia_Fall11-PU_S6_START42_V14B-v1_September12_NewSelection_2_v6_partALL.root"));
                //chain->Add(Form("miniTree_TTJets_TuneZ2_7TeV-madgraph-tauola_NewSelection_3_v1_partALL.root"));
                //chain->Add(Form("miniTree_WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_NewSelection_3_v1_partALL.root"));
        }
