...
do
		...
		do
			...
			do
				...
				qsub batchJob.sh ${sample} ${sample}_${isZgamma}_thesis_v4f_recoEnergy ${isZgamma} ${lumi_set} ${pileup_set} ${lowMuMuCut} ${highMuMuCut} ${scCorrection} 1.0 3 0.0 ${inj_resolution} ${itoy} ${analysisVersion} -l os=sl6 
                                ##hadd miniTree_${sample}_${isZgamma}_thesis_v4f_recoEnergy_partALL.root miniTree_${sample}_${isZgamma}_thesis_v4f_recoEnergy_part[0-9]*root
                                ##mv miniTree_${sample}_${isZgamma}_thesis_v4f_recoEnergy_part[0-9]*root stored_miniTree/
                                ##mv ${sample}_${isZgamma}_thesis_v4f_recoEnergy_part[0-9]*err stored_errput/
				##mv ${sample}_${isZgamma}_thesis_v4f_recoEnergy_part[0-9]*out stored_output/
