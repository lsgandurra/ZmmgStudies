...
do
		...
		do
			...
			for itoy in `seq 1 100` ##modif title with MuSys_itoy${itoy}
			do
				...
				##qsub batchJob.sh ${sample} ${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1 ${isZgamma} ${lumi_set} ${pileup_set} ${lowMuMuCut} ${highMuMuCut} ${scCorrection} 1.0 3 0.0 ${inj_resolution} ${itoy} ${analysisVersion} -l os=sl6 
                                ##hadd miniTree_${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1_partALL.root miniTree_${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1_part[0-9]*root
                                mv miniTree_${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1_part[0-9]*root stored_miniTree/
                                ##mv ${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1_part[0-9]*err stored_errput/
				##mv ${sample}_${isZgamma}_MuSys_itoy${itoy}_thesis_v1_part[0-9]*out stored_output/
			done
