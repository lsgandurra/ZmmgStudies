...
cp ${SPSDIR}/Zmumugamma/Selection/Skim_v03.exe ${TMPDIR}/
...
echo "EXECUTE JOB"
cd ${TMPDIR}/
#./Skim_v03.exe ${1} ${2} ${3} ${4} ${5} ${6} 2> ${2}.err | tee ${2}.out
./Skim_v03.exe ${1} ${2} ${ijob} 2> ${2}_part${ijob}.err | tee ${2}_part${ijob}.out
