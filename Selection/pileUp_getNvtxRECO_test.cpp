...
if( ntotjob == 9999 )
{
  ...
  //inputRunTree->Add(Form("/sps/cms/obondu/CMSSW_4_2_8__RECO_4_2_8_v2/src/Zmumugamma/TotoSamples/%s/%s*root", sample_char, sample_char));
	inputEventTree->Add("DYToMuMuSample_test.root");
	inputRunTree->Add("DYToMuMuSample_test.root");
...
*/
	...
	miniTree->Branch("nVerticesRECO", &nVerticesRECO, "nVerticesRECO/I");
...
//    {
			...
			nVerticesRECO = vertices->GetEntries();
			weight_pileUp = weight_DYToMuMu(nVertices+1);
//    }
